...
function read_more_about_meta_box_display() {
	...
	echo '<p>';
	echo '<label for="read_more_color_scheme">' . __( 'Color Scheme', 'read-more-about' ) . '</label>';
	echo '<select class="read_more_color_scheme" name="read_more_color_scheme">';
	...
	echo '<section class="read-more-link-fields">';
		echo '<p>';
		...
		echo '<a class="button read-more-remove-row" href="#">' . __( 'Remove Link', 'read-more-about' ) . '</a>';
	echo '</section>';
	...
	echo '<section class="read-more-empty-row screen-reader-text">';
		echo '<p>';
			echo '<label for="read_more_about_in_ex">' . __( 'External/Internal Link', 'read-more-about' ) . '</label>';
